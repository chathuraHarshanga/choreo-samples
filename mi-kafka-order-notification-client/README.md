...
2. Create a service component in WSO2 Developer Platform under the WSO2 MI build preset.
...
1. Send a POST request to the `/produce` endpoint with the following payload:
    ...
    ```
2. Observe the logs in the WSO2 Developer Platform console. You should see the order payload logged by the consumer.