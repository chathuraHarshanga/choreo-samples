...
Please refer to the [documentation](https://wso2.com/choreo/docs/develop-components/develop-a-rest-api-proxy/#step-1-create-a-rest-api-proxy) to learn how to deploy the application by providing the [link to the OpenAPI Specification](https://raw.githubusercontent.com/wso2/choreo-samples/main/proxy/openapi.yaml).
