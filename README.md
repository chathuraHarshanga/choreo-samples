# WSO2 Developer Platform Samples

This repository contains a collection of sample projects ready to deploy in [WSO2 Developer Platform](https://console.choreo.dev/), a developer platform for easily taking your work to production. These samples demonstrate various use cases and provide examples for different scenarios.

## Samples

You can explore the `README.md` of each sample in its respective directory to learn more about how to use WSO2 Developer Platform for specific use cases.

## Getting Started

Follow these steps to get started with these WSO2 Developer Platform samples:
...
2. Add a `README.md` file to the directory with the following information:
    ...
    - Instructions on how to deploy the sample in WSO2 Developer Platform.
...
## Contact
If you have any questions or need assistance, you can join the [WSO2 Developer Platform community Discord channel](https://discord.com/channels/955510916064092180/1027661953335820379).
