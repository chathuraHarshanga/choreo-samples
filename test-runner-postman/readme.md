...
When the test runner component is triggered manually, it will run a job to execute automated tests implemented by the developer. Test results can be viewed from the WSO2 Developer Platform console.
...
Let's write some tests using Postman collections and run those tests in WSO2 Developer Platform.
